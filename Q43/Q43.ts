...
const originalMagicians = ["David Copperfield", "Penn Jillette", "Teller", "David Blaine"];
...
const copyMagicians = originalMagicians.slice();

// Call make_great() with the copy of the array
const greatMagicians = make_great(copyMagicians);
