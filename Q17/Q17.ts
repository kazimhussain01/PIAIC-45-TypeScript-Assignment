...
let removeguest = ["Zain", "AbuBakar", "Ali"]
let message = "Ali I'm sorry I can't invite you to dinner at the Night"
//Remove guests from your list one at a time until only two names remain in your list. Each time you pop a name from your list
removeguest.pop()
//Print a message to each of the two people still on your list, letting them know they’re still invited.
let inviteguest = "I am still inviting you to the feast"
/* Remove the last two names from your list, so you have an empty list. Print your list to make sure you actually have an empty 
list at the end of your program
*/ 
removeguest.shift();
removeguest.shift();
console.log(`${removeguest[0]} ${inviteguest}`)
console.log(`${removeguest[1]} ${inviteguest}`)
console.log(`${removeguest[2]} ${message}`)
