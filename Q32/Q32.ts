...
let currentUser = ["kazim", "taqi", "hussain", "hassan", "zain"]
...
let newUser = ["ali", "kazim", "fareed", "hassan", "husnain"]
...
//Make sure your comparison is case insensitive. If 'John' has been used, 'JOHN' should not be accepted    
    let Newuser = newUser[i].toLowerCase();
    if (currentUser.includes(Newuser)){
        console.log(`Sorry, The UserName '${Newuser}' is Already Available. Please Enter a Different UserName`);
        } else {
